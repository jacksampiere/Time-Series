...
# read data
df = read.csv('spotifycharts_20170629to20180126_au.csv') # Australia
...
m.10 = add_country_holidays(m.10, country_name = 'AU')
...
m.50 = add_country_holidays(m.50, country_name = 'AU')
...
m.200 = add_country_holidays(m.200, country_name = 'AU')
